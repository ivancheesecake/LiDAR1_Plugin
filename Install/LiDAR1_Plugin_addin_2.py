...
class ApplySymbology(object):
    ...
    def __init__(self):
        ...
        self.checked = False
    def onClick(self):
        pythonaddins.GPToolDialog("C:/LiDAR1_Plugin_1.3/LiDAR1_Toolbox.tbx", "ApplySymbology")
...
class ButtonGenerateIndices(object):
    ...
    def __init__(self):
        ...
        self.checked = False
    def onClick(self):
        pythonaddins.GPToolDialog("C:/LiDAR1_Plugin_1.3/LiDAR1_Toolbox.tbx", "GenerateIndicesBatch")
...
class LoadIndices(object):
    ...
    def __init__(self):
        ...
        self.checked = False
    def onClick(self):
         pythonaddins.GPToolDialog("C:/LiDAR1_Plugin_1.3/LiDAR1_Toolbox.tbx", "LoadIndices")
...
class CalculateRMSE(object):
    ...
    def __init__(self):
        ...
        self.checked = False
    def onClick(self):
        pythonaddins.GPToolDialog("C:/LiDAR1_Plugin_1.3/LiDAR1_Toolbox.tbx", "CalculateRMSE")
...
class CalibrateDTM(object):
    ...
    def __init__(self):
        ...
        self.checked = False
    def onClick(self):
        pythonaddins.GPToolDialog("C:/LiDAR1_Plugin_1.3/LiDAR1_Toolbox.tbx", "CalibrateDTM")
...
class CenterLines(object):
    ...
    def __init__(self):
        ...
        self.checked = False
    def onClick(self):
        pythonaddins.GPToolDialog("C:/LiDAR1_Plugin_1.3/LiDAR1_Toolbox.tbx", "GenerateMidline")
